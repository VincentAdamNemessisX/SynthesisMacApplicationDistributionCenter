$(document).ready(function(){
	...
	$('#btn-09').click(function(){
		$.dialog({
			type : 'info',
	        infoText : '加载中…',
			infoIcon : '/static/front/img/icon/loading.gif',
			autoClose : 2500			
		});
	});
	...
	$('#btn-10').click(function(){
		$.dialog({
			type : 'info',
	        infoText : '操作成功',
			infoIcon : '/static/front/img/icon/success.png',
			autoClose : 2500
		});
	});
	...
	$('#btn-11').click(function(){
		$.dialog({
			type : 'info',
	        infoText : '操作失败',
			infoIcon : '/static/front/img/icon/fail.png',
			autoClose : 2500			
		});
	});
	...
	$('#btn-12').click(function(){
		$.dialog({
			type : 'info',
	        contentHtml : '<img class="info-icon" src="/static/front/img/icon/success.png" alt="操作成功" /><p class="info-text">操作成功</p>',
			autoClose : 2500			
		});
	});
