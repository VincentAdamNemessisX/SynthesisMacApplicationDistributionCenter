...
!function (t) {
	...
	t("#modal-new-url").on("blur", function () {
		var e = t(this);
		"" != e.val() && (isURL(e.val()) ? P != e.val() && (P = e.val(), x(e.val(), t(".add_new_sites_modal"))) : showAlert(JSON.parse('{"status":4,"msg":"URL 无效！"}')))
		...
		a.hasClass("down_count") && t.ajax({
			type: "POST", url: '/software/api/', data: a.data(), success: function (e) {
				t(".down-count-text").html(e)
			}
		}), i && copyText(i, function () {
			Swal.fire(localize.extractionCode)
		}, function () {
		}, this)
	}), loadFunc(function () {
...
}, console.log("\n OverGod" + " Page Theme By VincentAdamNemessis %c https://vincentadam.icu/ \n", "color: red; background: #000; padding:5px 0;background: #030307; padding:5px 0;");
!function (e, t) {
