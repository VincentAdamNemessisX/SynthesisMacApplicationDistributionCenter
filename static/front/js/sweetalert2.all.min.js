	...
	var Nt = function (t, e) {
			...
			!function (t, e) {
				...
				if (o) {
					...
					if (e.icon || e.iconHtml) {
						if (e.icon && -1 === Object.keys(k).indexOf(e.icon)) return T('Unknown icon! Expected "success", "error", "warning", "info" or "init_questions", got "'.concat(e.icon, '"')), void ft(o);
		...
		Qt = function (t) {
			...
			if (e && n && o && i) {
				...
				if (!(document.activeElement instanceof HTMLElement) || r.includes(document.activeElement)) {
					var a = ee.includes(t) ? "nextElementSibling" : "previousElementSibling", c = document.activeElement;
					if (c) {
