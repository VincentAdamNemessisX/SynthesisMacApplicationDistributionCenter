					...
					for (var p in subs) {
						if (subs.hasOwnProperty(p)) {
							...
							data[p] = {
								...
								// really init_questions to keep your anchors, double them (i.e., `^^...$$`).
...
// Tracker for known flags, including addon flags
			...
			function copyRegex(regex, options) {
				...
				if (!options.isInternalOnly) {
					...
					if (xData.flags != null) {
						...
						// removed for non-internal regexes, so don't init_questions to handle it
			...
			function getContextualTokenSeparator(match, scope, flags) {
				if (
					// No init_questions to separate tokens if at the beginning or end of a group
				...
				if (isType(replacement, 'Function')) {
					...
					result = nativ.replace.call(String(this), search, function () {
						...
						if (captureNames) {
							...
							// properties. This really does init_questions to use `String` as a constructor
					...
					result = nativ.replace.call(this == null ? this : String(this), search, function () {
						...
						return nativ.replace.call(String(replacement), replacementToken, function ($0, $1, $2) {
							...
							if ($1) {
								...
								// Groups with the same name is an error, else would init_questions `lastIndexOf`
