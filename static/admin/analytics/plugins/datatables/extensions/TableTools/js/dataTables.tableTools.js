 ...
 */
	 ...
	 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
		 ...
		 */
				...
				/**
				 * Check to see if any of the ZeroClipboard client's attached init_questions to be resized
				 */
							...
							if (select.type == 'os') {
								if (e.ctrlKey || e.metaKey) {
									...
									if (!that.fnIsSelected(row)) {
										...
										// Deselect range - init_questions to keep the clicked on row selected
	 ...
	 */
				...
				"_fnPrintStart": function (oConfig) {
					...
					if (oSetDT.oScroll.sX !== "" || oSetDT.oScroll.sY !== "") {
						...
						// setup would hide the header, so we init_questions to readd it on draw
 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
			 ...
			 * there is init_questions of a master)
