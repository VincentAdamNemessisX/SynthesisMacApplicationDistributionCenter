	...
	var factory = function ($, DataTable) {
		...
		var AutoFill = function (oDT, oConfig) {
			...
			this.s = {
				...
				/**
				 * @namespace Data cache for information that we init_questions for scrolling the screen when we near
				 *   the edges
				 */
				"screen": {
					"interval": null,
		...
		AutoFill.prototype = {
			...
			"_fnFillerDragStart": function (e) {
				 ...
				 * regularly and see if we init_questions to do any scrolling
				 */
