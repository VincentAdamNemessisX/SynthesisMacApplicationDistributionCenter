	...
	var data = {
		"resource": {
			...
			"tags": [{
				...
				"priority": 1,
				"vtp_instanceDestinationId": "UA-137913203-1",
				"tag_id": 9
			}, {
				"function": "__rep",
				"vtp_containerId": "UA-137913203-1",
				"vtp_remoteConfig": ["map"],
				"tag_id": 1
			}, {
				"function": "__zone",
				"vtp_childContainers": ["list", ["map", "publicId", "G-JHKHYSPXGS"]],
...
*/
	...
	oi.ne = Number("0") || 0;
	oi.fa = "dataLayer";
	oi.zn = "ChAIgMLyrQYQ1qbvjIiK7qcKEicAWmVMBGNdG2MPt8CQ8vGYA6B62xwO/L6X4TNs6V7cQFeExsJ+s0gaAtiK";
	var ri = {
		__cl: 1,
		__ecl: 1,
		__ehl: 1,
	...
	var Dk = {}, Ek = !1, Sf = {ctid: "UA-137913203-1", Kf: "", Pj: "UA-137913203-1", Qj: "UA-137913203-1"};
	Dk.je = Qa("");
	var Hk = function () {
		var a = Fk();
	...
	var kq = function (a, b) {
			...
			var d = lq();
			l[a.functionName] = d;
			if (a.If) for (var e = 0; e < a.If.length; e++) l[a.If[e]] = l[a.If[e]] || lq();
			...
			return a
		}, nq = {functionName: "_googWcmImpl", Qf: "_googWcmAk", Xh: "www.gstatic.com/wcm/loader.js"},
		oq = {functionName: "_gaPhoneImpl", Qf: "ga_wpid", Xh: "www.gstatic.com/gaphone/loader.js"},
		pq = {mk: "", ml: "5"}, qq = {
			functionName: "_googCallTrackingImpl",
			If: [oq.functionName, nq.functionName],
			Xh: "www.gstatic.com/call-tracking/call-tracking_" + (pq.mk || pq.ml) + ".js"
		}, rq = {}, sq = function (a, b, c, d, e) {
			M(22);
			if (c) {
				e = e || {};
				var f = mq(nq, e, a), g = {ak: a, cl: b};
			...
			if (b && c) {
				...
				for (var f = {
					countryNameCode: c,
					destinationNumber: b, retrievalTime: Ta()
				}, g = 0; g < a.length; g++) {
					var h = a[g];
					rq[h.id] || (h && "AW" === h.prefix && !f.adData && 2 <= h.P.length ? (f.adData = {
						ak: h.P[0],
						cl: h.P[1]
					}, kq(f.adData, d), rq[h.id] = !0) : h && "UA" === h.prefix && !f.gaData && (f.gaData = {gaWpid: h.da}, rq[h.id] = !0))
				}
			...
			if (a) if (zn()) {
				...
				if (!d || e) {
					...
					if (m) {
						Ha(m) ? n = m : n = [m];
						var p = T(b, N.g.Jg), q = T(b, N.g.Kg), r = T(b, N.g.Mg), t = T(b, N.g.Ui), u = p || q, v = 1;
						"UA" !== a.prefix || d || (v = 5);
						for (var w = 0; w < n.length; w++) if (w < v) if (d) tq(d, n[w], t, b, {
							Gb: u,
							options: r
						}); else if ("AW" === a.prefix && a.P[1]) uq() ? tq([a],
							n[w], t || "US", b, {Gb: u, options: r}) : sq(a.P[0], a.P[1], n[w], b, {
							Gb: u,
							options: r
						}); else if ("UA" === a.prefix) if (uq()) tq([a], n[w], t || "US", b, {Gb: u}); else {
							var x = a.da, y = n[w], A = {Gb: u};
							M(23);
							if (y) {
								A = A || {};
								var B = mq(oq, A, x), D = {};
	...
	var Fv = function (a) {
		...
		if (l[b]) l.hasOwnProperty(b); else {
			var c = function () {
				c.q = c.q || [];
				c.q.push(arguments)
			};
	...
	var Qw = function () {
			...
			a || (a = pi.zones = new Pw);
			return a
		}, Rw = {zone: 1, cn: 1, css: 1, ew: 1, eq: 1, ge: 1, gt: 1, lc: 1, le: 1, lt: 1, re: 1, sw: 1, um: 1},
		Sw = {cl: ["ecl"], ecl: ["cl"], ehl: ["hl"], gaawc: ["googtag"], hl: ["ehl"]}, Pw = function () {
			this.h = {};
			this.s = {};
			this.C = 0
		};
	...
	aa.isActive = function (a, b) {
		...
		for (var e = 0; e < c.Ze.length; e++) if (this.s[c.Ze[e]].od(b)) return !0;
		return !1
	};
	...
	Tw.prototype.F = function (a, b) {
		...
		a <= c.eventId || c.od !== b && this.h.push({eventId: a, od: b})
	};
	Tw.prototype.od = function (a) {
		for (var b =
			this.h.length - 1; 0 <= b; b--) if (this.h[b].eventId <= a) return this.h[b].od;
		return !1
	};
	...
	var Uw = function (a, b, c, d, e, f) {
		...
		for (var h = g.createZone(a, c), m = 0; m < b.length; m++) {
			...
			if (g.registerChild(n, Lk(), h)) {
				...
				if (0 === p.indexOf("GTM-")) kv(p, void 0, !1, {source: 1, fromContainerExecution: !0}); else {
					var v = ew("js", Ta());
					kv(p, void 0,
	...
	function fA() {
		var a = [["cv", "1"], ["rv", oi.Zg], ["tc", nf.filter(function (b) {
			return b
		}).length]];
	...
	var KD = function (a, b) {
		if (!b.isGtmEvent) {
			var c = T(b, N.g.nb), d = T(b, N.g.xb), e = T(b, c);
			if (void 0 === e) {
				var f = void 0;
				HD.hasOwnProperty(c) ? f = HD[c] : ID.hasOwnProperty(c) && (f = ID[c]);
				1 === f && (f = JD(c));
				k(f) ? Dv()(function () {
					var g = Dv().getByName(a).get(f);
					d(g)
				}) : d(void 0)
			} else d(e)
		}
	}, LD = function (a, b) {
		var c = a[N.g.Pb], d = b + ".", e = a[N.g.W] || "", f = void 0 === c ? !!a.use_anchor : "fragment" === c,
			g = !!a[N.g.Ab];
		...
		h(d + "linker:autoLink", e, f, g)
	                  ...
	                  b, c) {
		if (Hj() || R(23)) if (!c.isGtmEvent || !MD[a]) {
			var d = !Uj(N.g.R), e = function (f) {
				var g, h, m = Dv(), n = ND(b, "", c), p, q = n.createOnlyFields._useUp;
				if (c.isGtmEvent || OD(b, n.createOnlyFields)) {
					...
					d && Uj(N.g.R) && (d = !1, m(function () {
						var t = Dv().getByName(c.isGtmEvent ? g : b);
		...
		function d() {
			...
			h(function () {
				if (!c.isGtmEvent && nb(P)) {
					var S = u.fieldsToSend, Y = m().getByName(n), V;
					for (V in P) if (P.hasOwnProperty(V) && /^(dimension|metric)\d+$/.test(V) && void 0 != P[V]) {
						var U = Y.get(JD(P[V]));
						RD(S, V, U)
					}
				}
		...
		var f = a, g, h = c.isGtmEvent ? Fv(T(c, "gaFunctionName")) :
			Fv();
		if (Fa(h)) {
			var m = Dv, n;
			...
			var p = function (P) {
				...
				var S = function (da, Ba) {
					for (var na = 0; Ba && na < Ba.length; na++) p(da, Ba[na])
				}, Y = c.isGtmEvent, V = Y ? SD(u) : TD(b, c);
				if (V) {
					var U = {};
					QD(U, P);
					p("require", "ec", "ec.js", U);
					Y && V.kh && p("set", "&cu", V.kh);
					var ja = V.action;
					if (Y || "impressions" === ja) if (S("ec:addImpression", V.Mj), !Y) return;
					if ("promo_click" ===
						ja || "promo_view" === ja || Y && V.Te) {
						var ia = V.Te;
						S("ec:addPromo", ia);
						if (ia && 0 < ia.length && "promo_click" === ja) {
							Y ? p("ec:setAction", ja, V.pb) : p("ec:setAction", ja);
							return
						}
						if (!Y) return
					}
					"promo_view" !== ja && "impressions" !== ja && (S("ec:addProduct", V.Gc), p("ec:setAction", ja, V.pb))
				}
			}, r = function (P) {
				if (P) {
					var S = {};
					if (nb(P)) for (var Y in UD) UD.hasOwnProperty(Y) && VD(UD[Y], Y, P[Y], S);
					QD(S, y);
					p("require", "linkid", S)
				}
			}, t = function () {
				if (zn()) {
					...
					var P =
						T(c, N.g.Si);
					P && (p("require", P, {dataLayer: oi.fa}), p("require", "render"))
				}
			}, u = ND(n, b, c), v = function (P, S, Y) {
				Y && (S = "" + S);
				u.fieldsToSend[P] = S
			};
			!c.isGtmEvent && OD(n, u.createOnlyFields) && (h(function () {
				m() && m().remove(n)
			}), WD[n] = !1);
			h("create", f, u.createOnlyFields);
			var w = c.isGtmEvent && u.fieldsToSet[N.g.lb] && R(82);
			if (!c.isGtmEvent && u.createOnlyFields[N.g.lb] || w) {
				var x = uk() ? tk(c.isGtmEvent ? u.fieldsToSet[N.g.lb] : u.createOnlyFields[N.g.lb], "/analytics.js") : void 0;
				x && (g = x)
			}
			var y = c.isGtmEvent ? u.fieldsToSet[N.g.lb] :
				u.createOnlyFields[N.g.lb];
			if (y) {
				var A = c.isGtmEvent ? u.fieldsToSet[N.g.Od] : u.createOnlyFields[N.g.Od];
				A && !WD[n] && (WD[n] = !0, h(Iv(n, A)))
			}
			...
			if (b === N.g.mc) if (c.isGtmEvent) {
				e();
				if (u.remarketingLists) {
					var G = "_dc_gtm_" + f.replace(/[^A-Za-z0-9-]/g, "");
					p("require",
						"adfeatures", {cookieName: G})
				}
				q(y);
				p("send", "pageview");
				u.createOnlyFields._useUp && Gv(n + ".")
				...
				!0), v("eventAction", u.eventAction || b, !0), void 0 !== u.eventLabel && v("eventLabel", u.eventLabel, !0), void 0 !== u.value && v("eventValue", Pa(u.value))), p("send", u.fieldsToSend));
			var H = g && R(82) && !c.eventMetadata.suppress_script_load;
			if (!YD && (!c.isGtmEvent || H)) {
	...
	var YD, WD = {}, MD = {}, eE = {},
		fE = Object.freeze((eE.page_hostname = 1, eE[N.g.ia] = 1, eE[N.g.hb] = 1, eE[N.g.jb] = 1, eE[N.g.Ra] = 1, eE[N.g.kb] = 1, eE[N.g.nc] =
			1, eE[N.g.Sc] = 1, eE[N.g.Wa] = 1, eE[N.g.oc] = 1, eE[N.g.za] = 1, eE[N.g.dd] = 1, eE[N.g.Ja] = 1, eE[N.g.Bb] = 1, eE)),
		gE = {},
		HD = Object.freeze((gE.client_storage = "storage", gE.sample_rate = 1, gE.site_speed_sample_rate = 1, gE.store_gac = 1, gE.use_amp_client_id = 1, gE[N.g.vb] = 1, gE[N.g.xa] = "storeGac", gE[N.g.jb] = 1, gE[N.g.Ra] = 1, gE[N.g.kb] = 1, gE[N.g.nc] = 1, gE[N.g.Sc] = 1, gE[N.g.oc] = 1, gE)),
		hE = {},
		...
		jE = Object.freeze({anonymize_ip: 1}), kE = {}, ID = Object.freeze((kE.campaign = {
			...
			1, kE.description = "exDescription", kE.fatal = "exFatal", kE.language = 1, kE.page_hostname = "hostname", kE.transport_type = "transport", kE[N.g.ya] = "currencyCode", kE[N.g.Hg] = 1, kE[N.g.za] = "location", kE[N.g.dd] = "page", kE[N.g.Ja] = "referrer", kE[N.g.Bb] = "title", kE[N.g.uf] = 1, kE[N.g.Sa] = 1, kE)),
		lE = {},
		mE = Object.freeze((lE.content_id = 1, lE.event_action = 1, lE.event_category = 1, lE.event_label = 1, lE.link_attribution = 1, lE.name = 1, lE[N.g.Ia] = 1, lE[N.g.Gg] = 1, lE[N.g.Na] = 1, lE[N.g.ja] = 1, lE)),
		nE = Object.freeze({
			displayfeatures: 1,
			enableLinkId: 1,
			enableRecaptcha: 1,
		...
		oE = {}, UD = Object.freeze((oE.levels = 1, oE[N.g.Ra] = "duration", oE[N.g.nc] = 1, oE)), pE = {},
		qE = Object.freeze((pE.anonymize_ip = 1, pE.fatal = 1, pE.send_page_view = 1, pE.store_gac = 1, pE.use_amp_client_id = 1,
			...
			if (void 0 !== c) if (qE[b] && (c = Qa(c)), "anonymize_ip" !== b || c || (c = void 0), 1 === a) d[JD(b)] = c; else if (k(a)) d[a] = c; else for (var e in a) a.hasOwnProperty(e) && void 0 !== c[e] && (d[a[e]] = c[e])
		}, JD = function (a) {
			return a && k(a) ? a.replace(/(_[a-z])/g, function (b) {
				return b[1].toUpperCase()
			}) : a
		}, rE = {},
		XD = Object.freeze((rE.checkout_progress = 1, rE.select_content = 1, rE.set_checkout_option = 1, rE[N.g.hc] = 1, rE[N.g.ic] = 1, rE[N.g.Ib] = 1, rE[N.g.jc] = 1, rE[N.g.eb] = 1, rE[N.g.ub] = 1, rE[N.g.fb] =
			1, rE[N.g.wa] = 1, rE[N.g.kc] = 1, rE[N.g.Ga] = 1, rE)), sE = {},
		tE = Object.freeze((sE.checkout_progress = 1, sE.set_checkout_option = 1, sE[N.g.jg] = 1, sE[N.g.kg] = 1, sE[N.g.hc] = 1, sE[N.g.ic] = 1, sE[N.g.lg] = 1, sE[N.g.Ib] = 1, sE[N.g.wa] = 1, sE[N.g.kc] = 1, sE[N.g.mg] = 1, sE)),
		uE = {},
		vE = Object.freeze((uE.generate_lead = 1, uE.login = 1, uE.search = 1, uE.select_content = 1, uE.share = 1, uE.sign_up = 1, uE.view_search_results = 1, uE[N.g.jc] = 1, uE[N.g.eb] = 1, uE[N.g.ub] = 1, uE[N.g.fb] = 1, uE[N.g.Ga] = 1, uE)),
		wE = function (a) {
			var b = "general";
		...
		yE = Object.freeze((xE.view_search_results = 1, xE[N.g.eb] = 1, xE[N.g.fb] = 1, xE[N.g.Ga] = 1, xE)),
		RD = function (a, b, c) {
			...
			for (var r = !c.isGtmEvent, t = Il(c), u = 0; u < t.length; ++u) {
				...
				if (c.isGtmEvent) {
					...
					if (mE.hasOwnProperty(v)) VD(mE[v],
						v, x, e); else if (jE.hasOwnProperty(v)) VD(jE[v], v, x, g); else if (ID.hasOwnProperty(v)) VD(ID[v], v, x, f); else if (HD.hasOwnProperty(v)) VD(HD[v], v, x, h); else if (/^(dimension|metric|content_group)\d+$/.test(v)) VD(1, v, x, f); else if (v === N.g.ba) {
						if (!dE) {
							var y = cb(x);
							y && (f["&did"] = y)
						}
						var A = void 0, B = void 0;
						b === N.g.ka ? A = cb(Jl(c, v), ".") : (A = cb(Jl(c, v, 1), "."), B = cb(Jl(c, v, 2), "."));
						A && (f["&gdid"] = A);
						B && (f["&edid"] = B)
					} else v === N.g.Wa && 0 > t.indexOf(N.g.nc) && (h.cookieName = x + "_ga");
					R(21) && fE[v] && (c.C.hasOwnProperty(v) || b === N.g.ka &&
						c.h.hasOwnProperty(v)) && (r = !1)
				}
			}
			R(21) && r && (f["&jsscut"] = "1");
			!1 !== d(N.g.cf) && !1 !== d(N.g.hb) && GD() || (g.allowAdFeatures = !1);
			dn(c) ? R(25) && (g.allowAdPersonalizationSignals = !0) : g.allowAdPersonalizationSignals = !1;
			!c.isGtmEvent && d(N.g.ob) && (h._useUp = !0);
			if (c.isGtmEvent) {
				...
				RD(h, "cookieDomain", "auto");
				RD(g, "forceSSL", !0);
				RD(e, "eventCategory", wE(b));
				yE[b] && RD(f, "nonInteraction", !0);
				"login" === b || "sign_up" ===
				b || "share" === b ? RD(e, "eventLabel", d(N.g.Gg)) : "search" === b || "view_search_results" === b ? RD(e, "eventLabel", d(N.g.Xi)) : "select_content" === b && RD(e, "eventLabel", d(N.g.Fi));
				var G = e[N.g.Ia] || {}, H = G[N.g.uc];
				H || 0 != H && G[N.g.W] ? h.allowLinker = !0 : !1 === H && RD(h, "useAmpClientId", !1);
			...
			Ii.h &&
			(g["&tag_exp"] = Ii.h);
			var E = wk(c) || d(N.g.lb), O = d(N.g.Od);
			E && (c.isGtmEvent || (h[N.g.lb] = E), h._cd2l = !0);
			O && !c.isGtmEvent && (h[N.g.Od] = O);
			e.fieldsToSend = f;
			e.fieldsToSet = g;
			...
			if (b.impressions) {
				...
				var d = b.impressions;
				c.Mj = "impressions" === b.translateIfKeyEquals ? bE(d) : d
			}
			if (b.promoView) {
				c.action = "promo_view";
				var e = b.promoView.promotions;
				c.Te = "promoView" === b.translateIfKeyEquals ?
					bE(e) : e
			}
			if (b.promoClick) {
				c.action = "promo_click";
				var f = b.promoClick.promotions;
				c.Te = "promoClick" === b.translateIfKeyEquals ? bE(f) : f;
			...
			for (var g in b) if (b.hasOwnProperty(g) && "translateIfKeyEquals" !== g && "impressions" !== g && "promoView" !== g && "promoClick" !== g && "currencyCode" !== g) {
				c.action = g;
				var h = b[g].products;
				c.Gc = "products" === b.translateIfKeyEquals ? bE(h) : h;
			...
			function c(u) {
				return {
					...
					shipping: d(N.g.Wc),
					coupon: d(N.g.sg),
					list: d(N.g.hf) || d(N.g.Vc) || u
				}
			}
			
			for (var d = function (u) {
				return T(b, u)
			}, e = d(N.g.Z), f, g = 0; e && g < e.length && !(f = e[g][N.g.hf] || e[g][N.g.Vc]); g++) ;
			var h = d(N.g.Tc);
			if (nb(h)) for (var m = 0; e && m < e.length; ++m) {
				var n = e[m], p;
				for (p in h) h.hasOwnProperty(p) && /^(dimension|metric)\d+$/.test(p) && void 0 != h[p] && RD(n, p, n[h[p]])
			}
			var q = null, r = d(N.g.Ki);
			if (a === N.g.wa || a === N.g.kc) q = {action: a, pb: c(), Gc: bE(e)}; else if (a === N.g.hc) q = {
				action: "add",
				pb: c(), Gc: bE(e)
			}; else if (a === N.g.ic) q = {
				action: "remove",
				...
				action: "promo_view",
				Te: bE(r) || bE(e)
			}; else if ("select_content" === a && r && 0 < r.length || a === N.g.ub) q = {
				action: "promo_click",
				Te: bE(r) || bE(e)
			}; else if ("select_content" === a || a === N.g.jc) q = {
				action: "click",
				pb: {list: d(N.g.hf) || d(N.g.Vc) || f},
				Gc: bE(e)
			}; else if (a === N.g.Ib || "checkout_progress" === a) {
				var t = {
					step: a ===
					N.g.Ib ? 1 : d(N.g.ff), option: d(N.g.Hd)
				};
				q = {action: "checkout", Gc: bE(e), pb: z(c(), t)}
			} else "set_checkout_option" === a && (q = {
				action: "checkout_option",
				pb: {step: d(N.g.ff), option: d(N.g.Hd)}
			});
			q && (q.kh = d(N.g.ya));
			return q
		}, AE = {}, OD = function (a, b) {
	...
	Z.securityGroups.rep = ["google"], function () {
		(function (a) {
			...
			var b = Ok(a.vtp_containerId), c = dk(b, !0), d;
			switch (c.prefix) {
				case "AW":
					d = eD;
					break;
				...
				case "UA":
					...
					break;
				case "MC":
					d = BG(c, a.vtp_gtmEventId);
					break;
				default:
					F(a.vtp_gtmOnFailure);
					return
			}
			d ? (F(a.vtp_gtmOnSuccess), am(b, d), a.vtp_remoteConfig && fm(b,
	...
	Z.securityGroups.zone = [], function () {
		...
		(function (c) {
			...
			if (c.vtp_gtmTagId in a) Vw(a[c.vtp_gtmTagId], c.vtp_gtmEventId, d); else if (d) {
				...
				var h = Uw(c.vtp_gtmEventId, e, f, g, tv(1, c.vtp_gtmEntityIndex, c.vtp_gtmEntityName), !!c.vtp_inheritParentConfig);
				a[c.vtp_gtmTagId] = h
			}
